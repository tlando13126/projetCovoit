...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\trajetsController' => 'getTrajetsControllerService',
    ...
    protected function getConnexionControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\connexionController', $this));
    ...
    protected function getFavorisControllerService()
    {
        ...
        $this->services['App\\Controller\\favorisController'] = $instance = new \App\Controller\favorisController();

        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\favorisController', $this));
    ...
    protected function getInscriptionControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\inscriptionController', $this));
     ...
     */
    protected function getMonCompteControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/monCompteController.php';

        $this->services['App\\Controller\\monCompteController'] = $instance = new \App\Controller\monCompteController();

        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\monCompteController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\trajetsController' shared autowired service.
     *
     * @return \App\Controller\trajetsController
     */
    protected function getTrajetsControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/trajetsController.php';

        $this->services['App\\Controller\\trajetsController'] = $instance = new \App\Controller\trajetsController();

        $instance->setContainer(($this->privates['.service_locator.csvSx8x'] ?? $this->get_ServiceLocator_CsvSx8xService())->withContext('App\\Controller\\trajetsController', $this));
